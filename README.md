...
- `MO-IT148 Homework_ IoT Data Simulation H3101 TEAM CTRL+ALT+ELITE ADET EDITION.csv` - Simulated logistics IoT dataset.
- `milestone1_worksheet_answers.md` - Milestone worksheet answers and recorded outputs.
